function Sim = Config341()
    ...
    NetConnectivity([1 3 6],3:11) = 1;
    NetConnectivity([4 5 ],5:11) = 2;
    NetConnectivity([2 3 4],12:16) = 1;
    NetConnectivity([1 3 5 6],17:23) = 2;
    NetConnectivity([2 4 5],24:30) = 1;
%     NetConnectivity([1 2 3 4 5 6],30:end) = 1;    
    NetConnectivity([1 2 3 ],32:34) = 1;
    NetConnectivity([1 2 3 6],36:38) = 1;
    NetConnectivity([1 2 3 ],40:42) = 1;
    NetConnectivity([4 5 6],32:34) = 2;
    NetConnectivity([4 5],36:39) = 1;
    NetConnectivity([4 5 6],40:42) = 2;
    NetConnectivity([1 2 3 4 5],44:49) = 1;
